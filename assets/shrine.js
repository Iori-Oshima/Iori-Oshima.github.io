...
(function () {
  ...
  var Store = (function () {
    ...
    var data = { visits: 0, first: '', last: '', lights: 0, worships: 0, sound: false };
  ...
  var Oracle = (function () {
    ...
    var TAKU = [
      ['大和合', '境は、混ざるために引かれている。', '分けておいたものを、一度ひとつの皿に落としてみよ。'],
      ['大和合', '白と赤のあいだに、名前のない色がある。', 'それを見た者は、もう戻れない。よい意味で。'],
      ['大和合', '傾けよ。ためらう手からは、何も落ちない。', '今日に限り、量を気にしなくてよい。'],
      ['大和合', '名前のない味を、名付けずにおけ。', '説明できないものを、そのまま持っていてよい。'],
      ['大和合', '二柱は、手を離していない。', '見えているとおりである。'],
      ['和合',   '白は白のままでよい。隣に赤があれば足りる。', '急いで混ざる必要はない。'],
      ['和合',   '冷蔵庫の扉は、一日に何度でも開けてよい。', '迷いは、確かめれば済むことが多い。'],
      ['和合',   'よく振られたものほど、まっすぐ出る。', '揺さぶられた日々を、無駄だと思うな。'],
      ['和合',   '皿の上には、まだ余白がある。', '足すことを恐れるな。'],
      ['和合',   '誰かの手が、二つの瓶を同時に傾ける。', 'その手は、たぶん自分の手である。'],
      ['和合',   'よく出る日と、出ない日がある。', '今日出ないのは、瓶のせいではない。'],
      ['小和合', '振らねば出ぬ。', '待っていても、落ちてこないものがある。'],
      ['小和合', '最初のひと垂れは、いつも少し薄い。', '始めたばかりのものを、それで判断するな。'],
      ['小和合', '蓋の縁に固まったものを、拭え。', '小さな滞りが、次を詰まらせる。'],
      ['小和合', '逆さに立てておけ。', '今日できるのは、明日のための準備だけかもしれない。'],
      ['小和合', '皿の端に寄せておいたものを、忘れるな。', '後で使うつもりだったものが、ある。'],
      ['小和合', '少しだけ、と思ったほうがうまくいく。', '控えめが吉。'],
      ['半和合', '出しすぎた分は、戻らない。', '惜しむな。次は少し手前で止めよ。'],
      ['半和合', '混ざりきらぬまま、皿は運ばれる。', '中途半端でも、出す時が来ている。'],
      ['半和合', '白が多いか、赤が多いか、まだ決まらぬ。', '決めなくてよい。今日は。'],
      ['半和合', '空気が混じった音がした。', '中身より先に、勢いだけが出ることがある。'],
      ['半和合', '同じ皿に落ちたからといって、すぐには混ざらぬ。', '隣り合う時間が、まだ要る。'],
      ['半和合', '迷ったら、皿を替えよ。', '中身ではなく、器のほうを疑え。'],
      ['未和合', 'まだ蓋が開いていない。', '今日は開けなくてよい。'],
      ['未和合', '新しい瓶の口には、封がある。', '手間を惜しめば、封ごと落ちる。'],
      ['未和合', '残量は、外からは見えぬ。', '相手のことも、自分のことも。'],
      ['未和合', '温度が足りぬ。', '冷えたままでは、なめらかに出ない。少し待て。'],
      ['未和合', '冷えたものは、まず手のひらで温めよ。', '順番がある。'],
      ['離',     '分離は、腐敗ではない。', '混ざらぬまま在ることを、失敗と呼ぶな。'],
      ['離',     '油と水は、長く置けば必ず別れる。', '別れた後にも、瓶は瓶のままである。'],
      ['離',     '二柱もまた、もとは別の瓶であった。', '今日離れていることを、恥じなくてよい。'],
      ['離',     '白は赤に、赤は白に、なりきれぬ。', 'なりきらぬことを、和合という。']
    ];
