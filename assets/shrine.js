...
(function () {
  ...
  var Oracle = (function () {
    ...
    /* 絵の説明。読み上げにも使う。
       10-mayo-ism / 11-ketchup-ism / 12-fighting は「二つの道」で、
       13-greeting は拝殿の御神体（images/mayo_fusion.png）で使っている。
       同じ絵が二度出ないよう、神託ではこの四点を使わない。 */
    var ALT = {
      '01-meet':         '手を上げる白油之命',
    ...
    /* 卦・言・註・絵 */
    var TAKU = [
      ['大和合', '境は、混ざるために引かれている。', '分けておいたものを、一度ひとつの皿に落としてみよ。', '04-love'],
      ...
      ['大和合', '二柱は、手を離していない。', '見えているとおりである。', '14-handstand'],
      ...
      ['半和合', '同じ皿に落ちたからといって、すぐには混ざらぬ。', '隣り合う時間が、まだ要る。', '06-no'],
      ...
      ['離',     '二柱もまた、もとは別の瓶であった。', '今日離れていることを、恥じなくてよい。', '03-sorry'],
